...
- 🚀 Fun fact: I love optimizing load times and turning red Lighthouse scores into pure green 100s!
...
### 🌟 Featured Projects & Core Competencies

- **Technical SEO & Speed Optimization**: Audited, restructured, and implemented server-side rendering (SSR) for multiple Next.js websites to achieve green Google PageSpeed insights scores and fix indexing issues.
- **Dynamic Content & Platform Architectures**: Designed Quill-based custom text editors, complete blog publishing lifecycles, and user administration platforms.
- **Web Automation**: Created robust scripts leveraging Puppeteer and stealth techniques to automate complex booking and extraction flows.
...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/Esrail2/Esrail2/output/github-contribution-grid-snake-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/Esrail2/Esrail2/output/github-contribution-grid-snake.svg">
    <img alt="github contribution grid snake animation" src="https://raw.githubusercontent.com/Esrail2/Esrail2/output/github-contribution-grid-snake.svg">
  </picture>
</p>
